...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference('Human.count') do
      post humen_url, params: { human: { age: @human.age, alive: @human.alive, birth: @human.birth, name: @human.name, profile: @human.profile } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { age: @human.age, alive: @human.alive, birth: @human.birth, name: @human.name, profile: @human.profile } }
